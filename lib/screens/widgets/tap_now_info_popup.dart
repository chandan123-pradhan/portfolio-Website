...
class TapNowInfoPopup extends StatefulWidget {
  @override
  _TapNowInfoPopupState createState() => _TapNowInfoPopupState();
}

class _TapNowInfoPopupState extends State<TapNowInfoPopup> with SingleTickerProviderStateMixin {
